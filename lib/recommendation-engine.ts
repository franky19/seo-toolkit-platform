...
export class RecommendationEngine {
  static generate(
    auditReport: Omit<AuditReport, "recommendations">,
  ): Recommendation[] {
    const recommendations: Recommendation[] = [];

    // SEO Audit Recommendations
    recommendations.push(
      ...this.generateSEORecommendations(auditReport.seoAudit),
    );

    // Google News Recommendations
    recommendations.push(
      ...this.generateGoogleNewsRecommendations(auditReport.googleNewsAudit),
    );

    // Schema Recommendations
    recommendations.push(
      ...this.generateSchemaRecommendations(auditReport.schemaValidation),
    );

    // Sitemap Recommendations
    recommendations.push(
      ...this.generateSitemapRecommendations(auditReport.sitemapValidation),
    );

    // AI Search Recommendations
    recommendations.push(
      ...this.generateAISearchRecommendations(auditReport.aiSearchAudit),
    );
  ...
  private static generateSEORecommendations(
    ...
    if (!seoAudit.meta.data.title) {
      recommendations.push({
        ...
        title: "Add Title Tag",
        description:
          "Your page is missing a title tag, which is crucial for SEO.",
        impact: "high",
        action:
          "Add a <title> tag in your HTML <head> section with a descriptive, keyword-rich title (30-60 characters).",
      });
    }
    ...
    if (!seoAudit.meta.data.description) {
      recommendations.push({
        ...
        description:
          "Meta description helps improve click-through rates from search results.",
        impact: "high",
        action:
          'Add <meta name="description" content="..."> with a compelling description (120-160 characters).',
      });
    }
    ...
    if (!seoAudit.meta.data.canonical) {
      recommendations.push({
        ...
        impact: "medium",
        action:
          'Add <link rel="canonical" href="..."> to specify the preferred URL for this page.',
      });
    }
  ...
  private static generateGoogleNewsRecommendations(
    ...
    if (!googleNewsAudit.hasNewsArticleSchema) {
      recommendations.push({
        ...
        impact: "high",
        action:
          'Add JSON-LD structured data with @type: "NewsArticle" including headline, author, datePublished, and image.',
      });
    }
    ...
    if (!googleNewsAudit.author) {
      recommendations.push({
        ...
        impact: "high",
        action:
          "Include author information in your NewsArticle schema and visible on the page.",
      });
    }
    ...
    if (!googleNewsAudit.publisher) {
      recommendations.push({
        ...
        description:
          "Publisher data helps Google identify your news organization.",
        impact: "high",
        action:
          "Add publisher information with name and logo in your NewsArticle schema.",
      });
    }
    ...
    if (!googleNewsAudit.datePublished) {
      recommendations.push({
        ...
        impact: "high",
        action:
          "Include datePublished in ISO 8601 format in your NewsArticle schema.",
      });
    }
    ...
    if (!googleNewsAudit.featuredImage) {
      recommendations.push({
        ...
        impact: "medium",
        action:
          "Add a high-quality featured image (minimum 1200x675px) to your article.",
      });
    }

    if (
      googleNewsAudit.headlineLength &&
      (googleNewsAudit.headlineLength < 10 ||
        googleNewsAudit.headlineLength > 110)
    ) {
      recommendations.push({
        priority: "MEDIUM",
  ...
  private static generateSchemaRecommendations(
    ...
    if (!schemaValidation.hasOrganization) {
      recommendations.push({
        ...
        impact: "high",
        action:
          'Add JSON-LD with @type: "Organization" including name, url, logo, and social media profiles.',
      });
    }
    ...
    if (!schemaValidation.hasArticle && !schemaValidation.hasNewsArticle) {
      recommendations.push({
        ...
        impact: "medium",
        action:
          'Add JSON-LD with @type: "Article" or "NewsArticle" for your content pages.',
      });
    }
    ...
    if (!schemaValidation.hasWebsite) {
      recommendations.push({
        ...
        impact: "low",
        action:
          'Add JSON-LD with @type: "WebSite" including name, url, and potentialAction for search.',
      });
    }
    ...
    if (!schemaValidation.hasBreadcrumb) {
      recommendations.push({
        ...
        impact: "low",
        action:
          'Add JSON-LD with @type: "BreadcrumbList" showing your site hierarchy.',
      });
    }
  ...
  private static generateSitemapRecommendations(
    ...
    if (sitemapValidation.sitemaps.length === 0) {
      recommendations.push({
        ...
        impact: "high",
        action:
          "Create a sitemap.xml file listing all your important pages and submit it to Google Search Console.",
      });
    }
    ...
    if (!sitemapValidation.newsSitemap) {
      recommendations.push({
        ...
        impact: "medium",
        action:
          "Create a news-sitemap.xml file for your news articles following Google News sitemap specifications.",
      });
    }
  ...
  private static generateAISearchRecommendations(
    ...
    if (!aiSearchAudit.hasFAQSchema) {
      recommendations.push({
        ...
        description:
          "FAQ schema helps AI assistants understand and cite your content.",
        impact: "medium",
        action:
          'Add JSON-LD with @type: "FAQPage" for pages with question-answer content.',
      });
    }
    ...
    if (!aiSearchAudit.hasAuthorSchema) {
      recommendations.push({
        ...
        description:
          "Author information improves E-E-A-T signals for AI search.",
        impact: "medium",
        action:
          'Include detailed author information with @type: "Person" schema including expertise and credentials.',
      });
    }
    ...
    if (!aiSearchAudit.hasLlmsTxt) {
      recommendations.push({
        ...
        impact: "low",
        action:
          "Create /llms.txt file with structured information about your site, features, and content.",
      });
    }
    ...
    if (!aiSearchAudit.hasAiTxt) {
      recommendations.push({
        ...
        impact: "low",
        action:
          "Create /ai.txt file with AI-friendly site documentation and usage guidelines.",
      });
    }
    ...
    if (aiSearchAudit.schemaCompleteness < 70) {
      recommendations.push({
        ...
        description:
          "More comprehensive structured data helps AI understand your content better.",
        impact: "medium",
