          ...
          <div className="max-w-5xl mx-auto">
            ...
            <article>
              <Link
                ...
                className="block card-surface rounded-2xl p-8 mb-8 group hover:border-indigo-500/20 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400/60"
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {rest.map((post) => (
                  <article key={post.slug}>
                    <Link
                      href={`/blog/${post.slug}`}
                      className="block card-surface rounded-2xl p-6 group hover:border-indigo-500/20 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400/60"
                    >
