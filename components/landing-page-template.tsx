  ...
  return (
    <div className="bg-[#0a0a0a] min-h-screen text-white">
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 relative overflow-hidden">
        ...
        />
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-indigo-600/8 rounded-full blur-3xl pointer-events-none"
          aria-hidden="true"
        />
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {features.map((f) => (
              <div
                key={f}
                className="flex items-start gap-3 p-4 card-surface rounded-xl">
                <CheckCircle2
